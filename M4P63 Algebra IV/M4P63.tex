...
\begin{definition}
A \textbf{chain complex} is a series $ A_* = \br{A_i} $, with maps $ d_i^A = d_i = d : A_{i + 1} \to A_i $ such that $ d^2 = 0 $, that is $ d_{i + 1} \circ d_i = 0 $, or $ \Im d_{i + 1} \le \Ker d_i $. A \textbf{cochain complex} is a series $ A^* = \br{A^i} $ with maps $ d_i^A = d_i = d : A^i \to A^{i + 1} $ such that $ d^2 = 0 $, or $ \Im d_i \le \Ker d_{i + 1} $.
\end{definition}

\begin{definition}
Let $ A_* $ be a chain complex. The \textbf{$ n $-th homology group} of $ A_* $ is $ \Ker d_{n - 1} / \Im d_n $. We write $ \H_n\br{A_*} $. Also write $ \H_*\br{A_*} = \br{\H_n\br{A_*}} $. Let $ A^* $ be a cochain complex. The \textbf{$ n $-th cohomology group} of $ A^* $ is $ \Ker d_n / \Im d_{n - 1} $. We write $ \H^n\br{A^*} $, and $ \H^*\br{A^*} = \br{\H^n\br{A^*}} $.
\end{definition}
...
Now $ \Ker d_{n - 1} / \Im d_n = \cbr{\br{0, b, 0} + 0^2 \oplus \ZZ} $.
\end{example*}
...
\begin{proposition}
A map of chain complexes $ f : A_* \to B_* $ induces a map on the homology, $ f_* : \H_*\br{A_*} \to \H_*\br{B_*} $, given by
...
Let $ A_* $ and $ B_* $ be chain complexes, and let $ f $ and $ g $ be maps between them. We say that $ f $ and $ g $ are \textbf{equal up to homotopy} if there exist maps $ s_i : A_i \to B_{i + 1} $ such that $ g_i - f_i = s_{i - 1} \circ d_{i - 1}^A + d_i^B \circ s_i $.
...
$$
\begin{tikzcd}
\dots \arrow{r} & \H_{n + 1}\br{A_*} \arrow{r} & \H_{n + 1}\br{B_*} \arrow{r} & \H_{n + 1}\br{C_*} \arrow[in=180, out=0, swap]{dll} & \\
& \H_n\br{A_*} \arrow{r} & \H_n\br{B_*} \arrow{r} & \H_n\br{C_*} \arrow[in=180, out=0, swap]{dll} & \\
& \H_{n - 1}\br{A_*} \arrow{r} & \H_{n - 1}\br{B_*} \arrow{r} & \H_{n - 1}\br{C_*} \arrow{r} & \dots
\end{tikzcd}.
$$
\end{proposition}
...
$$
\begin{tikzcd}
0 \arrow{r} & A_{n + 1} \arrow{r} \arrow{d}{d_n^A} & B_{n + 1} \arrow{r} \arrow{d}{d_n^B} & C_{n + 1} \arrow{r} \arrow{d}{d_n^C} & 0 \\
...
0 \arrow{r} & \Ker d_{n - 1}^A \arrow{r} & \Ker d_{n - 1}^B \arrow{r} & \Ker d_{n - 1}^C &
\end{tikzcd}.
$$
Now $ \Im d_{n + 1} \le \Ker d_n $, so the maps $ A_{n + 1} \to \Ker d_{n + 1} $ induce maps $ A_{n + 1} / \Im d_{n + 1} \to \Ker d_{n - 1} $. So we get a diagram
$$
\begin{tikzcd}
& A_{n + 1} / \Im d_{n + 1}^A \arrow{r} \arrow{d} & B_{n + 1} / \Im d_{n + 1}^B \arrow{r} \arrow{d} & C_{n + 1} / \Im d_{n + 1}^C \arrow{r} \arrow{d} & 0 \\
0 \arrow{r} & \Ker d_{n - 1}^A \arrow{r} & \Ker d_{n - 1}^B \arrow{r} & \Ker d_{n - 1}^C &
\end{tikzcd}.
$$
We are now in the position to apply the snake lemma.
\end{proof}
