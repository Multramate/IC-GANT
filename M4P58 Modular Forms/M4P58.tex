...
$$ \abr{f, g}_k = \iintd{\DDD}{f\br{z}\overline{g\br{z}}\dfrac{\br{\Im z}^k}{\br{\Im z}^2}}{x}{y}. $$
\end{definition}

Here $ z = x + iy $ and $ \overline{z} = x - iy $, so $ \d z\d\overline{z} = \br{\d x + i\d y} \wedge \br{\d x - i\d y} = -2i\br{\d x \wedge \d y} $, so can also write this as
$$ \abr{f, g}_k = \dfrac{i}{2}\iintd{\DDD}{f\br{z}\overline{g\br{z}}\dfrac{\br{\Im z}^k}{\br{\Im z}^2}}{z}{\overline{z}}. $$
Then
