...
$$
\end{itemize}
Thus $ M = \text{$ 0 $-cell} \ \sqcup \ \text{two $ 1 $-cells} \ \sqcup \ \text{$ 2 $-cell} $.
\end{example}
...
\begin{example}
Let $ f : T \to \RR $ be as in the previous example. Then the critical points $ 0, a, b, c $ have index $ \lambda = 0, 1, 1, 2 $ respectively.
\end{example}
