...
$$ \int_N F^*\br{\omega} = \sum_\alpha \int_N \br{f_\alpha \circ F}F^*\omega = \sum_\alpha \int_N F^*\br{f_\alpha\omega} = \sum_\alpha \int_M f_\alpha\omega = \int_M \omega. $$
\end{enumerate}
\end{proof}
...
Thus $ G^* : \Z^p\br{N} \to \Z^p\br{M} $ and $ G^* : \B^p\br{N} \to \B^p\br{M} $, so there exists a linear map
...
\begin{proof}
By Proposition \ref{prop:2.7} there exists $ F^* : \H^p\br{N} \to \H^p\br{M} $ and $ \br{F^{-1}}^* : \H^p\br{M} \to \H^p\br{N} $. By Proposition \ref{prop:1.8}, for all $ \omega \in \H^p\br{N} $,
$$ \br{F^{-1}}^*F^*\omega = \br{F \circ F^{-1}}^*\omega = \id_N^*\omega = \omega, $$
