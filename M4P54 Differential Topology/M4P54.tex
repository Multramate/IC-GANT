...
& \Ker \alpha_1 \arrow{r} \arrow{d} & \Ker \alpha_2 \arrow{r} \arrow{d} & \Ker \alpha_3 \arrow{d} \arrow[out=0, in=180]{dddll} & \\
...
The idea is given a manifold $ M $, we may write $ M = U \cup V $ with open $ U $ and $ V $ so that $ H^i\br{U} $, $ H^i\br{V} $, and $ H^i\br{U \cap V} $ are easy to compute, so this will give us $ H^i\br{M} $.

\begin{example*}
Let $ M = \S^2 $, and let $ U = M \setminus \cbr{n} $ and $ V = M \setminus \cbr{s} $. Then $ U, V \cong \RR^2 $ and $ U \cap V \cong \S^1 $.
\end{example*}

Let $ M $ be a manifold, and let $ U $ and $ V $ be open such that $ M = U \cup V $. Assume $ U \cap V \ne \emptyset $. Let
