...
\begin{proof}
$ \sb{K\rb{\alpha} : K} = \deg\rb{\alpha} $ and $ \sb{K\rb{\alpha, \beta} : K\rb{\alpha}} \le \deg\rb{\beta} $, so $ \sb{K\rb{\alpha, \beta} : K} \le \rb{\deg\rb{\alpha}}\rb{\deg\rb{\beta}} $. Now $ K \subseteq K\rb{\alpha + \beta} \subseteq K\rb{\alpha, \beta} $, so $ \deg\rb{\alpha + \beta} $ over $ K $ is less than $ \rb{\deg\rb{\alpha}}\rb{\deg\rb{\beta}} $. Similarly for $ \alpha\beta $.
\end{proof}
