...
$$ \delta : E\rb{\Q} \to \Q^* / \rb{\Q^*}^2 \times \Q^* / \rb{\Q^*}^2 \times \Q^* / \rb{\Q^*}^2, \qquad \rb{x, y} \mapsto \rb{a, b, c} $$
...
\item If $ P_1 = O $, then $ P_2 + P_3 = O $ so $ P_3 = -P_2 $. Then $ \delta\rb{P_3} = \delta\rb{-P_2} = \delta\rb{P_2} $. So $ \delta\rb{P_1}\delta\rb{P_2}\delta\rb{P_3} = \delta\rb{P_2}^2 = 1 $.
...
$ \delta : E\rb{\Q} / 2E\rb{\Q} \cong Im\rb{\delta} $. Next is prove that if $ K = \Q $, $ Im\rb{\delta} $ is finite.
