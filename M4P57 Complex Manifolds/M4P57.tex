...
$$ \Omega_{X, \CC}^1 = \Omega_{X, \CC}^1 = \Omega_{X, \CC}^{1, 0} \oplus \Omega_{X, \CC}^{0, 1} = \br{\T_X^{1, 0}}^* \oplus \br{\T_X^{0, 1}}^* $$
be the dual of the complex vector bundle $ \T_X^\CC $.

\begin{exercise*}
Let $ V $ and $ W $ be vector spaces. Show that
$$ \Lambda^p\br{V \oplus W} = \bigoplus_{a + b = p} \Lambda^aV \otimes \Lambda^bW. $$
\end{exercise*}
