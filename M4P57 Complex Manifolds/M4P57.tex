...
Let $ V $ be a vector space over $ \CC $ of dimension $ n $ with an inner product $ \abr{\cdot, \cdot} : V \times V \to \CC $. There is a canonical inner product on $ \Lambda^pV $ for all $ p \ge 1 $,
...
\begin{align*}
\br{\d\alpha, \beta}
& = \int_X \d\alpha \wedge \star\beta & \cbr{\eta_1, \eta_2}\omega^n = \eta_1 \wedge \star\eta_2 \\
& = \int_X \d\br{\alpha \wedge \star\beta} - \br{-1}^k\int_X \alpha \wedge \d\br{\star\beta} & \text{the Leibnitz rule} \\
& = \br{-1}^{k + 1}\int_X \alpha \wedge \d\br{\star\beta} & \text{Stokes} \\
& = \br{-1}^{\br{n - k}k + k + 1}\int_X \alpha \wedge \star\star\d\br{\star\beta} & \star\star\eta = \br{-1}^{k\br{n - k}}\eta \\
& = \br{-1}^{nk + 1}\int_X \alpha \wedge \star\star\d\br{\star\beta} & k^2 - k \ \text{is even} \\
& = \br{-1}^{nk + 1}\int_X \cbr{\alpha, \star\d\br{\star\beta}}\omega^n & \cbr{\eta_1, \eta_2}\omega^n = \eta_1 \wedge \star\eta_2 \\
& = \br{-1}^{nk + 1}\br{\alpha, \star\d\br{\star\beta}}.
\end{align*}
\end{proof}
...
$$ 0 = \br{\Delta\alpha, \alpha} = \br{\d\br{\d^*\alpha} + \d^*\br{\d\alpha}, \alpha} = \br{\d^*\alpha, \d^*\alpha} + \br{\d\alpha, \d\alpha} = \norm{\d^*\alpha}^2 + \norm{\d\alpha}^2, $$
...
\begin{proof}
Use $ \d^* = \br{-1}^{nk + 1}\star\d\star $ and $ \star\star = \br{-1}^{k\br{n - k}} $.
\end{proof}
...
\begin{proof}
$$ \cbr{\Delta\alpha, \beta}\omega^n = \cbr{\d\br{\d^*\alpha}0 + \d^*\br{\d\alpha}, \beta}\omega^n = \cbr{\alpha, \d^*\br{\d\beta} + \d\br{\d^*\beta}}\omega^n = \cbr{\alpha, \Delta\beta}\omega^n. $$
\end{proof}
...
$$ \H^k\br{X, \CC} \to \H^{n - k}\br{X, \CC}, \qquad k \ge 0. $$
\end{theorem}
