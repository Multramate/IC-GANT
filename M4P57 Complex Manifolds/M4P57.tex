...
Let $ V $ be a vector space over $ \RR $ of dimension $ n $ with an inner product $ \abr{\cdot, \cdot} : V \times V \to \RR $. There is a canonical inner product on $ \Lambda^pV $ for all $ p \ge 1 $,
...
$ \xi_1, \dots, \xi_n $ are \textbf{normal coordinates} for the K\"ahler metric.
...
\hfill
\begin{enumerate}
\item $ \sbr{\overline{\partial}^*, \L} = \overline{\partial}^*\L - \L\overline{\partial}^* = -\star\overline{\partial}\star\L + \L\star\overline{\partial}\star $. We want to check that $ 1 $ holds at $ x \in X $. But around $ x $, we may assume that
