...
\fill (0, 0) circle (1) node[below left]{$ e $};
\fill (64, 0) circle (1) node[below left]{$ a $};
\fill (0, 64) circle (1) node[below left]{$ b $};
\fill (-64, 0) circle (1) node[below left]{$ a^{-1} $};
\fill (0, -64) circle (1) node[below left]{$ b^{-1} $};
\draw (0, 0) to (64, 0);
\draw (0, 0) to (0, 64);
\draw (0, 0) to (-64, 0);
\draw (0, 0) to (0, -64);
...
\drawleft{-64}{0}{32}{6}
\drawbelow{0}{-64}{32}{6}
\draw (0, -160) node[above]{$ \Gamma\br{\F\br{\cbr{a, b}}, \cbr{a, b}} $};
\end{tikzpicture}
$$
}
\def\syllabus{Bass-Serre graphs. Cayley graphs. Words and paths. Free groups. Presentations of groups. Group actions on graphs. The Nielson-Schreier theorem. Fundamental groups of graphs. Free products of groups. Amalgamated free products. HNN extensions. Graphs of groups. The fundamental structure theorem of Bass-Serre theory.}
\def\thm{subsection}
...
\begin{definition}[Fundamental groups of graphs of groups I]
...
\begin{definition}[Fundamental groups of graphs of groups II]
...
\begin{theorem}[Fundamental theorem of Bass-Serre theory I]
\label{thm:2.7.2}
...
\begin{theorem}[Fundamental theorem of Bass-Serre theory II]
\label{thm:2.7.5}
...
\begin{theorem}[Kurosh subgroup theorem]
