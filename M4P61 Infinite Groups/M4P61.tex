...
Similarly $ A^2 = -\I_2 $. Set $ X_1 = \RR_{< 0} $ and $ X_2 = \RR_{> 0} $. Then $ Ax = -1 / x $, $ Bx = 1 - 1 / x $, and $ B^2x = -1 / \br{x - 1} $. Now clearly $ A \cdot X_i = X_j $ and $ B \cdot X_1 \subsetneq X_2 $. Hence $ \PSL_2\br{\ZZ} \cong \abr{A} * \abr{B} \cong \ZZ_2 * \ZZ_3 $.
\end{proof}
