...
\begin{remark1}[First aid topology]
\label{rem:2.19}
\hfill
\begin{itemize}
...
\begin{equation}
\label{eq:10}
x_2^2 \cdot \HH_P = \rb{d - 1}^2 \cdot \det\begin{pmatrix}
...
and
$$ x_2 \cdot \HH_P = \det\three{C_0}{C_1}{x_0C_0 + x_1C_1 + x_2C_2} = \det\begin{pmatrix}
P_{x_0, x_0} & P_{x_0, x_1} & \rb{d - 1}P_{x_0} \\
P_{x_1, x_0} & P_{x_1, x_1} & \rb{d - 1}P_{x_1} \\
P_{x_2, x_0} & P_{x_2, x_1} & \rb{d - 1}P_{x_2}
\end{pmatrix}, $$
that is
$$ x_2 \cdot \HH_P = \rb{d - 1}\det\begin{pmatrix}
P_{x_0, x_0} & P_{x_0, x_1} & P_{x_0} \\
P_{x_1, x_0} & P_{x_1, x_1} & P_{x_1} \\
...
\end{pmatrix}. $$
Similarly,
$$ x_2^2 \cdot \HH_P = \rb{d - 1}\det\begin{pmatrix}
R_0' \\
R_1' \\
...
$$ x_1^2 \cdot \HH_P = \rb{d - 1}^2 \cdot \det\begin{pmatrix}
...
\end{pmatrix}, $$
so that
$$ 0 = \HH_P\rb{0, 1, 0} = 4\det\begin{pmatrix}
...
\end{pmatrix}, $$
so that
$$ p_1^2 \cdot \HH_P\rb{p} = \rb{d - 1}^2 \cdot \det\begin{pmatrix}
P_{x_0, x_0} & P_{x_0} & P_{x_0, x_2} \\
P_{x_0} & 0 & 0 \\
P_{x_0, x_2} & 0 & 0
\end{pmatrix} = 0. $$
Do the same for $ p_0 $,
$$ p_0^2 \cdot \HH_P\rb{p} = \rb{d - 1}^2 \cdot \det\begin{pmatrix}
0 & P_{x_1} & 0 \\
