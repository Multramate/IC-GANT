...
$$ \function[f_i]{\P^{n - 1}}{\mathcal{P}_i}{\sb{z_0, \dots, z_{n - 1}}}{\sb{z_0, \dots, z_{i - 1}, 0, z_i, \dots, z_{n - 1}}}, $$
...
$$ \correspondence{\text{projective plane curves} \ \overline{C} = \cb{P = 0} \subseteq \P^2 \ \text{that} \\ \text{do not contain the line at infinity} \ \mathcal{P}_2 = \cb{x_2 = 0}}{\text{affine curves} \ C = \cb{f = 0} \subseteq \C^2}. $$
