...
$$ f\rb{x, y} = P\rb{x, y, 1} = \sum_{i = 0}^n a_i\rb{y, 1}x^i = \sum_{i = 0}^n \tilde{a_i}\rb{y}x^i, $$
where $ \tilde{a_i}\rb{y} = a_i\rb{y, 1} $ and similarly let
$$ g\rb{x, y} = Q\rb{x, y, 1} = \sum_{i = 0}^m b_i\rb{y, 1}x^i = \sum_{i = 0}^m \tilde{b_i}\rb{y}x^i, $$
where $ \tilde{b_i}\rb{y} = b_i\rb{y, 1} $. Then
...
$$ i < r \qquad \implies \qquad mult_0\rb{\tilde{a_i}\rb{y}} \ge r - i, $$
that is
$$ i < r \qquad \implies \qquad \tilde{a_i}\rb{y} = y^{r - i} \cdot A_i\rb{y}, $$
and similarly
$$ i < s \qquad \implies \qquad \tilde{b_i}\rb{y} = y^{s - i} \cdot B_i\rb{y}, $$
