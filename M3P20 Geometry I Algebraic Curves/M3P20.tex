...
\begin{theorem}
Let $ \bar{C} \subseteq \P^2 $ be a projective curve defined by a polynomial of degree $ d $ that does not contain $ \mathcal{P}_2 $. Then $ \bar{C} \cap \mathcal{P}_2 $ is a non-empty set of at most $ d = \deg\rb{Q} $ points.
\end{theorem}
