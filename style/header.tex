...
\newoperator{alg}   % Algebraic closure
\newoperator{Ann}   % Annihilator
\newoperator{area}  % Area
\newoperator{Aut}   % Automorphism group
...
\newoperator{Em}    % Embedding set
\newoperator{End}   % Endomorphism ring
\newoperator{fin}   % Finite subset
\newoperator{Fix}   % Fixed group
\newoperator{Frac}  % Fraction field
\newoperator{Fun}   % Function
\newoperator{Gal}   % Galois group
\newoperator{GL}    % General linear group
\newoperator{Ham}   % Hamming weight
\newoperator{Homeo} % Homeomorphism group
\newoperator{Hom}   % Homomorphism group
\newoperator{id}    % Identity function
\newoperator{Im}    % Image
\newoperator{Ind}   % Index
\newoperator{Ker}   % Kernel
\newoperator{lcm}   % Least common multiple
\newoperator{Mat}   % Matrix ring
\newoperator{mult}  % Multiplicity
\newoperator{Nm}    % Norm
\newoperator{ord}   % Order of vanishing
\newoperator{Pay}   % Payley graph
\newoperator{PG}    % Projective geometry
\newoperator{PGL}   % Projective general linear group
\newoperator{PSL}   % Projective special linear group
...
\newoperator{row}   % Row
\newoperator{sgn}   % Sign
\newoperator{Sing}  % Singular points
\newoperator{sp}    % Span
\newoperator{SL}    % Special linear group
\newoperator{SO}    % Special orthogonal group
\newoperator{Spec}  % Spectrum
\newoperator{Stab}  % Stabiliser
\newoperator{star}  % Star
\newoperator{srg}   % Strongly regular graph
\newoperator{Sym}   % Symmetric group
