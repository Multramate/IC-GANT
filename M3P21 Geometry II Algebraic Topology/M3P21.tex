...
\& \& 0 \& \& 0 \& \& 0 \& \& \& \\
\& \dots \arrow[near start]{rr}{\da} \& \& A_{n + 1}' \arrow[near start]{rr}{\da} \arrow[near start]{dd}{i'} \& \& A_n' \arrow[near start]{rr}{\da} \arrow[near start]{dd}{i'} \& \& A_{n - 1}' \arrow[near start]{rr}{\da} \arrow[near start]{dd}{i'} \& \& \dots \\
\dots \arrow[near start]{rr}{\da} \& \& A_{n + 1} \arrow[from=uu, crossing over, near start] \arrow{ur}{\alpha} \arrow[crossing over, near start]{rr}{\da} \& \& A_n \arrow[from=uu, crossing over, near start] \arrow{ur}{\alpha} \arrow[crossing over, near start]{rr}{\da} \& \& A_{n - 1} \arrow[from=uu, crossing over, near start] \arrow{ur}{\alpha} \arrow[crossing over, near start]{rr}{\da} \& \& \dots \& \\
\& \dots \arrow[near start]{rr}{\da} \& \& B_{n + 1}' \arrow[near start]{rr}{\da} \arrow[near start]{dd}{j'} \& \& B_n' \arrow[near start]{rr}{\da} \arrow[near start]{dd}{j'} \& \& B_{n - 1}' \arrow[near start]{rr}{\da} \arrow[near start]{dd}{j'} \& \& \dots \\
\dots \arrow[near start]{rr}{\da} \& \& B_{n + 1} \arrow[from=uu, crossing over, near start]{}{i} \arrow{ur}{\beta} \arrow[crossing over, near start]{rr}{\da} \& \& B_n \arrow[from=uu, crossing over, near start]{}{i} \arrow{ur}{\beta} \arrow[crossing over, near start]{rr}{\da} \& \& B_{n - 1} \arrow[from=uu, crossing over, near start]{}{i} \arrow{ur}{\beta} \arrow[crossing over, near start]{rr}{\da} \& \& \dots \& \\
\& \dots \arrow[near start]{rr}{\da} \& \& C_{n + 1}' \arrow[near start]{rr}{\da} \arrow[near start]{dd} \& \& C_n' \arrow[near start]{rr}{\da} \arrow[near start]{dd} \& \& C_{n - 1}' \arrow[near start]{rr}{\da} \arrow[near start]{dd} \& \& \dots \\
\dots \arrow[near start]{rr}{\da} \& \& C_{n + 1} \arrow[from=uu, crossing over, near start]{}{j} \arrow{ur}{\gamma} \arrow[crossing over, near start]{rr}{\da} \& \& C_n \arrow[from=uu, crossing over, near start]{}{j} \arrow{ur}{\gamma} \arrow[crossing over, near start]{rr}{\da} \& \& C_{n - 1} \arrow[from=uu, crossing over, near start]{}{j} \arrow{ur}{\gamma} \arrow[crossing over, near start]{rr}{\da} \& \& \dots \& \\
\& \& \& 0 \& \& 0 \& \& 0 \& \& \\
...
Then $ \epsilon $ is surjective. It is enough to show that $ \ker \epsilon = \im \da_1 $. This implies by the isomorphism theorem $ \H_0\br{X} \cong \ZZ $. Let $ \sigma : \Delta^1 \to X $ be a $ 1 $-simplex. Then
...
Then $ \Delta^n \times \I $ is not a simplex. But we can subdivide $ \Delta^n \times \I $ into $ \br{n + 1} $ simplices. In general, we can decompose $ \Delta^n \times \I $ into $ n + 1 $ distinct $ \br{n + 1} $-simplices
...
\begin{example*}
Let $ U, V \subseteq \RR^n $ be two path-connected open subsets such that $ U \cup V = \RR^n $. Then $ U \cap V $ is path-connected as well. It is enough to show that $ \H_0\br{U \cap V} \cong \ZZ $, if and only if $ \widetilde{\H_0}\br{U \cap V} = 0 $. Then $ U \cap V \ne \emptyset $ because $ \RR^n $ is connected, and $ U $ and $ V $ are open, so $ \mathring{U} = U $ and $ \mathring{V} = V $, so $ \mathring{U} \cup \mathring{V} = \RR^n $. Mayer-Vietoris long exact sequence for reduced homology groups implies that
$$
\begin{tikzcd}[row sep=tiny]
...
\item[$ 5 $.] It is enough to show it for $ i = 1 $. Induction on $ n $.
\begin{itemize}[leftmargin=0.5in]
