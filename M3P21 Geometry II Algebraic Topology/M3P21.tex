...
$$ \dots \xrightarrow{\partial} \widetilde{H_1}\rb{A} \xrightarrow{i_*} \widetilde{H_1}\rb{X} \xrightarrow{j_*} \widetilde{H_1}\rb{X / A} \xrightarrow{\partial} \widetilde{H_0}\rb{A} \xrightarrow{i_*} \widetilde{H_0}\rb{X} \xrightarrow{j_*} \widetilde{H_0}\rb{X / A} \to 0, $$
...
Let $ X $ be a topological space and $ A \subseteq X $ be a subspace. Define $ C_n\rb{X, A} = C_n\rb{X} / C_n\rb{A} $. Let $ \partial : C_n\rb{X} \to C_{n - 1}\rb{X} $ be the boundary map then $ \partial\rb{\sigma : \Delta^n \to A} \in \partial\rb{C_n\rb{A}} \subseteq C_{n - 1}\rb{A} $. So $ \partial $ induces a homomorphism
