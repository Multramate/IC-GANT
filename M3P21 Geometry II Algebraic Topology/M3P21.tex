...
We say that a topological space $ X $ has a certain property $ \rb{P} $ locally if for each point $ x \in X $ and each neighbourhood $ U $ of $ x $ there is an open neighbourhood $ V \subseteq U $ having this property $ \rb{P} $.
