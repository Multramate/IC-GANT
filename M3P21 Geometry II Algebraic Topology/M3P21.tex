...
\begin{itemize}
\item $ \Delta_0\rb{K} = \cb{n \cdot v \mid n \in \Z} \cong \Z $.
\item $ \Delta_1\rb{K} = \cb{n_1 \cdot a + n_2 \cdot b + n_3 \cdot c \mid n_1, n_2, n_3 \in \Z} \cong \Z^3 $.
\item $ \Delta_2\rb{K} = \cb{n_1 \cdot U + n_2 \cdot V \mid n_1, n_2 \in \Z} \cong \Z^2 $.
