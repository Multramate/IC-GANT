...
\begin{note*}
There is more than one possible definition of generically finite for non-dominant rational maps used by different authors. I shall avoid the issue by only using the words generically finite when the map is dominant.
\end{note*}
