...
\subsubsection{Veronese embedding}
...
I mentioned last time that we can strengthen Lemma \ref{lem:closeddimension} to a strict inequality, as long as $ W \ne V $. In this lemma, it is essential that $ V $ is irreducible, whereas in Lemma \ref{lem:closeddimension}, that condition is not necessary.
