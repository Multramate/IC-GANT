...
\item Since $ \abr{0} \subsetneq \abr{p} $ for $ p $ a prime number, $ \dim \ZZ = 1 $.
...
\item[$ \impliedby $] Now assume that $ A $ is Noetherian and $ \dim A = 0 $. By Emmy Noether's theorem the ideal $ \abr{0} $ has a primary decomposition, that is $ \abr{0} = J_1 \cap \dots \cap J_n $, where $ J_i $'s are primary. Recall $ \rad J_i $ is a prime ideal of $ A $. Since $ \dim A = 0 $, this ideal is maximal. The associated primes of $ \abr{0} $ are maximal ideals. By Corollary \ref{cor:13.11} each $ J_i $ contains a power of $ \rad J_i $. Therefore, the product of these powers of these maximal ideals is contained in $ \prod_{i = 1}^n J_i \subset \bigcap_{i = 1}^n J_i = \abr{0} $. Now Lemma \ref{lem:13.13} implies that $ A $ is Artinian.
\end{itemize}
\end{proof}
...
\begin{theorem}
Any Artinian ring is a product of finitely many local Artinian rings.
\end{theorem}
...
\item $ \phi $ is injective if and only if $ \bigcap_{j = 1}^n I_j = \abr{0} $.
\end{itemize}
\end{lemma}
