...
Another approach is to define $ a_n $ for $ i = 1, 2, \dots $ to be a Cauchy sequence if for any $ m \ge 1 $ there exists an $ N \ge 1 $ such that for any $ n \ge N $, $ a_n - a_N \in I^m $. Any Cauchy sequence has a limit in $ \widehat{R} $.
