...
(Exercise: check that if $ \rb{a, s} \sim \rb{a', s'} $ and $ \rb{b, t} \sim \rb{b', t'} $, then $ \rb{ab, st} \sim \rb{a'b', s't'} $)

(Exercise: check that if $ \rb{a, s} \sim \rb{a', s'} $ and $ \rb{b, t} \sim \rb{b', t'} $, then $ \rb{at + bs, st} \sim \rb{a't' + b's', s't'} $)
...
(Exercise: do the same in the Artinian case)
...
\marginpar{Lecture 21 \\ Tuesday \\ 20/11/18}
...
\marginpar{Lecture 23 \\ Monday \\ 26/11/18}
...
\marginpar{Lecture 24 \\ Tuesday \\ 27/11/18}

Lecture 24 is a test.

\marginpar{Lecture 25 \\ Friday \\ 30/11/18}

Lecture 25 is a problem class.

\marginpar{Lecture 26 \\ Monday \\ 03/12/18}
...
\marginpar{Lecture 27 \\ Tuesday \\ 04/12/18}
...
\marginpar{Lecture 28 \\ Friday \\ 07/12/18}
...
(Exercise: $ R = \cb{x \in K \mid v\rb{x} \ge 0} $ is a ring, called the valuation ring of $ v $)

(Exercise: if $ R^* = \cb{x \in K \mid v\rb{x} = 0} $, $ R \setminus R^* = \cb{x \in K \mid v\rb{x} > 0} $ is the unique maximal ideal of $ R $, thus every valuation ring is a local integral domain)
...
\marginpar{Lecture 29 \\ Monday \\ 10/12/18}
...
\marginpar{Lecture 30 \\ Tuesday \\ 11/12/18}
