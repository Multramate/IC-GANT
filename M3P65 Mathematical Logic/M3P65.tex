...
\item Extensionality. Sets $ A $ and $ B $ are equal iff $ \fab{x}\iffb{\rb{x \in A}}{\rb{x \in B}} $.
...
$$ n . m_1m_2 \dots \mapsto \begin{cases} \rb{0, n, m_1, m_2, \dots} & n \ge 0 \\ -n . m_1m_2 \dots \mapsto \rb{1, -n, m_1, m_2, \dots} & n < 0 \end{cases}. $$
\end{example}
